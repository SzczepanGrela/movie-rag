      ...
      <main className="mx-auto max-w-3xl px-4 py-16 sm:py-24">
        ...
        <section className="mb-16 space-y-5 text-center">
          ...
          <p className="mx-auto max-w-xl text-base text-muted-foreground">
            A semantic search engine over 4,719 films. Describe a vibe, a plot,
            or a feeling — and find the movie, even when you can't recall its
            name.
          </p>
        ...
        <section className="mb-16">
          ...
          <div className="space-y-3 text-sm leading-relaxed text-foreground/80">
            <p>
              Keyword search breaks the moment you don't know the exact words.
              Ask for <em>"a film where a guy jumps off a building"</em> and a
              literal index returns nothing useful.
            </p>
            <p>
              ...
              calls retrieval tools, and reasons over structured plot data to
              name the film.
            </p>
          </div>
        </section>
        ...
        <section className="mb-16">
          ...
          <p className="mb-6 text-sm leading-relaxed text-foreground/80">
            ...
            themes, atmosphere, quotes, characters), embedded with
            EmbeddingGemma, and stored in pgvector. Posters go to Cloudflare R2
            with BlurHash placeholders.
          </p>
          <EtlDiagram />
        </section>
