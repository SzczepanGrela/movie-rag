          ...
          <div className="space-y-4">
            ...
            {data.results.map((r) => {
              ...
              return (
                <Card
                  key={r.movie_id}
                  className="group cursor-pointer transition-all border-border/80 hover:border-primary/50 hover:shadow-[0_10px_40px_-12px_rgba(245,213,71,0.25)] hover:-translate-y-0.5"
                >
                  <CardHeader>
